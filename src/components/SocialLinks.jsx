    ...
    <div className='hidden lg:flex flex-col top-[35%] left-0 fixed'>
        <ul>
            ...
            {links.map(({id, child, href, style, download}) => (
                <li key={id} className={'flex justify-between items-center w-40 h-14 px-4 ml-[-100px] border-2  border-gray-500 hover:border-red-500 hover:rounded-md hover:ml-[10px] duration-700 bg-gray-500 ' + style}>
